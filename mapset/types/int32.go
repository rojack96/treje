...
// Int32Set - Create a new empty set or from a slice
func (m MapSet) Int32Set(elems ...int32) (Int32Set, error) {
	set := Int32Set{}
...
func (set *Int32Set) ToSet() (stype.Int32Set, error) {
	var (
		slice  []int32
		result stype.Int32Set
		err    error
	)
