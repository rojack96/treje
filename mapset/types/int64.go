...
// Int64Set - Create a new empty set or from a slice
func (m MapSet) Int64Set(elems ...int64) (Int64Set, error) {
	set := Int64Set{}
...
func (set *Int64Set) ToSet() (stype.Int64Set, error) {
	var (
		slice  []int64
		result stype.Int64Set
		err    error
	)
